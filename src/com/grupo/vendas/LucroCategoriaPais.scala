...
object LucroCategoriaPais {
    ...
    ((linhaQuebrada(13).trim() + "," + linhaQuebrada(10).trim()), linhaQuebrada(19).replace(",", ".").trim().toFloat)
  }
  ...
  def main(args: Array[String]){
    ...
    //inverte os valores da tupla para (Lucro, "Categoria, País")
    ...
    dataFrameProdutos.write.option("header", "false").csv("./exportacao/dataFrameLucroCategoriaPais.csv")    
